...
#file=$1 # Input file
file=/home/genis/saola/analyses/beagle_pcangsd/results_mergedseq/beagle/all.beagle.gz
nfile=admixNotransSaolaall26
num=100  # Maximum number of iterations
P=40 #numer of threads/cores used

K=$1 #number of populations. Max ligger på antal lokaliteter, men 2-8 må være passende
out=/home/genis/saola/analyses/ngsadmix/results_all26/$K #output  directory (no /)
